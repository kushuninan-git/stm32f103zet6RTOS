...
void setup_scr_screen_data(lv_ui *ui){
	...
	lv_obj_set_size(ui->screen_data_label_time, 190, 0);
	...
	lv_obj_set_pos(ui->screen_data_label_tem, 20, 65);
	lv_obj_set_size(ui->screen_data_label_tem, 60, 0);
	...
	lv_obj_set_pos(ui->screen_data_img_wifi, 200, 8);
