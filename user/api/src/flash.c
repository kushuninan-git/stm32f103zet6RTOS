...
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13|GPIO_Pin_15; //ӽޅ
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;//̙׈ 
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;//ģʽ ڌݾࠢ˖ӡ125ҳ/Ԓݼ͸ת
//	GPIO_Init(GPIOB, &GPIO_InitStructure);
//	
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14; //ӽޅ	
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;//ģʽ 
//	GPIO_Init(GPIOB, &GPIO_InitStructure);	
//	
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12; //ӽޅ	
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;//ģʽ 
//	GPIO_Init(GPIOB, &GPIO_InitStructure);
//	
//	GPIO_WriteBit(GPIOB, GPIO_Pin_12, Bit_SET);//-ٟCS
//  //΢ʨ
//	SPI_InitTypeDef  SPI_InitStructure;
//  SPI_InitStructure.SPI_Direction = SPI_Direction_2Lines_FullDuplex;//˽ߝ׽в
//  SPI_InitStructure.SPI_Mode = SPI_Mode_Master;//SPIģʽ ׷ܺ
//  SPI_InitStructure.SPI_DataSize = SPI_DataSize_8b;//˽ߝճС
//  SPI_InitStructure.SPI_CPOL = SPI_CPOL_Low;//CPOL
//  SPI_InitStructure.SPI_CPHA = SPI_CPHA_1Edge;//CPHA
//  SPI_InitStructure.SPI_NSS = SPI_NSS_Soft;//NSSڜm
//  SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_8;//ؖƵϵ˽
//  SPI_InitStructure.SPI_FirstBit = SPI_FirstBit_MSB;//ٟλЈԫ
//  SPI_InitStructure.SPI_CRCPolynomial = 7;//CRCݬҩ
